...
func main() {
	...
	doc3 := documentstore2.Document{
		Fields: map[string]documentstore2.DocumentField{
			"key":  {Type: documentstore2.DocumentFieldTypeString, Value: "user:4"},
			"tags": {Type: documentstore2.DocumentFieldTypeArray, Value: []string{"golang", "doc"}},
			"meta": {Type: documentstore2.DocumentFieldTypeObject, Value: map[string]interface{}{"author": "John"}},
		},
	}
	//Перевірка пустого ключа
	doc4 := documentstore2.Document{
		Fields: map[string]documentstore2.DocumentField{
			"key":  {Type: documentstore2.DocumentFieldTypeString, Value: ""},
			"tags": {Type: documentstore2.DocumentFieldTypeArray, Value: []string{"golang", "doc"}},
			"meta": {Type: documentstore2.DocumentFieldTypeObject, Value: map[string]interface{}{"author": "John"}},
		},
	}
